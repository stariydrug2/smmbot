...
class Settings:
    ...
    feature_competitor_monitoring: bool = field(default_factory=lambda: _env_bool('FEATURE_COMPETITOR_MONITORING', False))
    feature_proactive: bool = field(default_factory=lambda: _env_bool('FEATURE_PROACTIVE', False))
