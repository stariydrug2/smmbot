...
async def results_section(
    ...
    await message.answer(
        ...
        f"Источников в радаре: <b>{results['competitor_sources']}</b>\n"
        f"Публикаций отслежено: <b>{results['competitor_posts']}</b>\n"
        f"Сильных сигналов найдено: <b>{results['strong_signals']}</b>\n\n"
